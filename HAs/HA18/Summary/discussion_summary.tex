...
\begin{comment}
MOBICON is a pretty top tier conferennc by ACM

All traffic is not equal 
	=> speed test is doing really weel 
	=> They mess with some traffic 
	
Saying our key insight is a good strategy for a paper

Supplying motivatiton is a good strat for setting up the rest of the paper 

When we show a graph we say what the graph is before talking
